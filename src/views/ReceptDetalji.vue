...
<script>
import ReceptV from "@/components/ReceptV.vue";
...
export default {
  ...
  async mounted() {
    console.log(this.id); //id je iz props dijela
    this.card = await Recepti.getOne(this.id); //poziv metode getOne za prikaz određenog recepta
  },
  methods: {
    //metoda za odjavu
    logout() {
